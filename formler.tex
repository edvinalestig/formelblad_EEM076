...
\\
\textbf{Gauss lag} \tab \( \vec{\Phi} = \oiint \vec{E} \cdot d\vec{A} = \frac{Q}{\epsilon_0} \)

\section{Konstanter}

Coloumbkonstanten \tab \( k_e = \frac{1}{4 \pi \epsilon_0} \)
\\
Elektrisk permittivitet i vakuum \tab \( \epsilon_0 = \frac{10^{-9}}{36 \pi} \)
\\
